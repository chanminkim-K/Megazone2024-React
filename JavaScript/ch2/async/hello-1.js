...
whatsYourFavorite()
    .then(displaySubject).then(console.log)

/** async Function 은 promise 객체 반환된다는 것을 알 수 있음
 * 
 * 따라서, async 의 함께 await 를 사용할 수 있음을 생각할 수 있음
 */
